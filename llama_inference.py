...
def main(args):
    ...
    for file in tqdm(files):
        ...
        completion = subprocess.run(["../codellama/llama.cpp/main", "-m", "../codellama/llama.cpp/models/7B/code-base-Q5_K.bin", "-c", "3324", "-n", "80", "-t", "0", "--multiline_input", "-p", prompt], capture_output=True)
